# HexOps Documentation

Welcome to the HexOps documentation. This guide covers installation, configuration, and all features.
...
- [Extending](development/extending.md) - Adding new features
